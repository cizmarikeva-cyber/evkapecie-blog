...
export const RECIPES = [
  ...
  {
    slug:       "pirohy",
    categories: ["Slané", "Varenie", "Tradičné"],
    ...
    steps: [
      {
        ...
        items: [
          ...
          "Rozdrobíme droždí s částí cukru, rozmícháme lžící a zalijeme vlažným mlékem (<b>190 ml</b>, max 40 °C). Necháme <b>10 minut</b> <b>stát</b>.",
          "V rendlíku smícháme <b>30 g mouky se 150 ml mléka</b>. Zahříváme na středním plameni za stálého míchání, dokud se nevytvoří hustá pasta — tang zhong. Jde to docela rychle. Dáme na talíř vychladnout.",
          ...
          "Těsto v míse zakryjeme vlhkou utěrkou a necháme cca <b>40 minut</b> kynout, dokud nezdvojnásobí objem.",
          ...
          "Housky položíme na plech s pečícím papírem (<b>6 ks na jeden plech</b>). Přikryjeme otočeným plechem a necháme <b>kynout</b>, až zdvojnásobí objem.",
          "Troubu předehřejeme na <b>190 °C</b> (bez horkovzduchu). Vejce rozšleháme vidličkou, potřeme housky a posypeme sezamem.",
          "<b>Pečeme</b> <b>16–18 minut</b> dozlatova a necháme vychladnout na mřížce.",
        ],
      },
    ],
    tips: {
    ...
    ingredients: [
      {
        group: "Těsto",
        items: [
          { amount: "3 ks",   name: "vejce (oddělit žloutky od bílků)" },
          { amount: "100 g",  name: "moučkový cukr" },
          { amount: " ",      name: "špetka vanilky" },
          { amount: "50 g",   name: "olej" },
      ...
      },
      {
        ...
        items: [
          { amount: "150 g",  name: "krémový sýr (žervé nebo Philadelphia)" },
          { amount: "60 g",   name: "krupicový cukr" },
          { amount: " ",      name: "špetka vanilky" },
          { amount: "1 ks",   name: "malé vejce" },
          { amount: "100 g",  name: "bílý jogurt (použila jsem Hollandia)" },
        ],
      },
      {
        group: "Na vrch",
    ...
    steps: [
      {
        ...
        items: [
          ...
          "Pečeme na <b>175 °C</b> po dobu <b>40–45 minut</b>. Propečení zkontrolujeme špejlí v místech, kde je těsto (ne v místě s ovocem nebo náplní).",
          "Koláč krájejte až po úplném vychladnutí.",
        ],
      },
    ],
    tips: {
      ...
      items: [
        ...
        "Cream cheese náplně se zdá být hodně. Zbyly mě asi 3 lžíce, ale po pečení jsem zjistila, že jsem mohla klidně spotřebovat celou dávku.",
      ],
    },
  },
